...
<div className="p-5 w-[95%] items center bg-black">
    <div className="bg-black text-white min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="w-96 h-12 rounded-full bg-white relative from-red-400 via-red-500 to-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-900 shadow-2xl shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 mx-5">
       <div
