...
<div classname="bg-gradient-to-r from-red-400 via-red-500 to-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80">
      ...
      <p className="text-xl mt-8 justify-center items-center p-1">Are you ready to be among the first to experience the future of learning?</p>
      <p className="text-lg mt-4 text-orange-800 justify-center items-center p-1">
